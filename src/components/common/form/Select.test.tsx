...
describe('Select', () => {
  it('asocia el label con el select y renderiza las opciones', () => {
    render(<Select label='Elige una' name='campo' options={options} />);

    const select = screen.getByLabelText('Elige una');
  ...
  it('permite seleccionar una opción', () => {
    ...
    const select = screen.getByLabelText('Elige una') as HTMLSelectElement;
